...
class devPlugGenerator(object):
    ...
    def __init__(self):
        ...
        self.qtConsole = DevConsolePlug.DevConsole(self.win, ShowPrint=True, ShowError=True, StatusBar=self.win.statusBar(), AsDock=True, InitalizeScripts=True, logCount=30)
