...
class PyQtAppSupport():
    ...
    def waitDialog(self, winHeading='Please wait...', label='Please wait...Processing!', textStyle = None, w=350, h=100, model=False, noClose=True, keyPressFunction=None, controlWidget=False):
