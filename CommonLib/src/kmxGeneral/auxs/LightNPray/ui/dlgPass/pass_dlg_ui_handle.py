...
#UI Packs
from pass_dlg_ui import Ui_Dialog
...
class PassDialog(QtGui.QDialog, Ui_Dialog):
    ...
    def sigListItemChange(self):
        ...
        itm2 = self.qtsList.getSelectedItemLabel(self.listWidget,'Data')
        self.le1.setText(itm)
        self.le2.setText(itm2)
