...
class AppInfos():
    ...
    def __init__(self):
        ...
        self.IconPath = 'Z:/REPO/CONFIG/BASEICONS/Other'

        self.pathMaya2011QTLib =  "Z:/REPO/SOURCE/APPS/pyqt/maya2011"
        self.pathMaya2011DBLib =  "Z:/REPO/SOURCE/APPS/Py2_6Apps/MySQL/64bit"
        self.pathMaya64QTLib = 'Z:/REPO/SOURCE/APPS/pyqt/64Bit'
        self.pathMaya64QTLib = "Z:/REPO/SOURCE/SCRIPTS/PYTHON/SqlWrapperLibrary/64bit"
        self.pathMaya32QTLib = "Z:/REPO/SOURCE/APPS/pyqt/32Bit"
        self.pathMaya32DBLib = "Z:/REPO/SOURCE/SCRIPTS/PYTHON/SqlWrapperLibrary/32bit"
