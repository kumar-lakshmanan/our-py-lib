...
#Special
from config_infos import Icons
from config_infos import AppInfos
from config_infos import LasedUsedInfos
from config_infos import DisplayStrings
...
if __name__ == '__main__':
    settingsfile = 'configs.ini'
    ap = AppConfigs(settingsfile)
    ap.UpdateAllConfigValues()