...
def showInputBox(callingUi,Title='Information',Message='Information',DefaultValue=''):
    comments, ok = QtGui.QInputDialog.getText(callingUi, str(Title), str(Message), QtGui.QLineEdit.Normal, DefaultValue)
